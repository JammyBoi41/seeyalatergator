...
const Navbar = () => {
  ...
  return (
    <div className='text-xl bg-blue-800 w-screen h-1/12 fixed top-0 left-0 border-gray-200 border-b-1 flex flex-row justify-between items-center px-5 z-[100]'> {/* div of navbar */}
